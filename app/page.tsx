    ...
    <div className="space-y-8">
      ...
      <div>
        <div className="flex items-center gap-2 mb-1">
          ...
          />
          <h1 className="text-2xl font-bold" style={{ color: "#0D2B2B" }}>
            Dashboard
          </h1>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-semibold text-sm" style={{ color: "#0D2B2B" }}>
                Manage Orders
              </p>
        ...
        >
          <div className="flex items-center gap-3">
            <div
              ...
              style={{ backgroundColor: "#2BBCBC" }}
            />
            <h2 className="font-semibold text-sm" style={{ color: "#0D2B2B" }}>
              Recent Orders
            </h2>
          </div>
          <Link
            ...
            <table className="w-full text-sm">
              <thead>
                <tr style={{ backgroundColor: "#2BBCBC" }}>
                  {["Customer", "Product", "Date", "Total", "Status"].map(
                    (h, i) => (
                      <th
                        key={h}
